...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------------+-------------+-------------+-------------+-------------------+------------|                                          |-------------------+-----------------+--------------+--------------+--------------+-------------------|
      OSL(LOWER2), LGUI_T(KC_C), LALT_T(KC_I), LCTL_T(KC_E), LT(SHIFT, KC_A),    KC_COMMA,                                               KC_DOT,             LT(SHIFT, KC_H),  RCTL_T(KC_T),  LALT_T(KC_S),  RGUI_T(KC_N),  OSL(SHIFT),
  //|------------+-------------+-------------+-------------+-------------------+------------|                                          |-------------------+-----------------+--------------+--------------+--------------+-------------------|
      KC_LCTL,     KC_G,         RALT_T(KC_X), KC_J,         KC_K,               KC_UNDS,                                                KC_QUES,            KC_R,             KC_M,          RALT_T(KC_F),  KC_P,          KC_LGUI,
  //|------------+-------------+-------------+-------------+-------------------+------------+-------------------|  |-------------------+-------------------+-----------------+--------------+--------------+--------------+-------------------|
                                                             LT(MULTI2, KC_ESC), KC_SPACE,    LT(MOUSE, KC_TAB),     LT(FUNC, KC_BSPC),  LT(LOWER2, KC_ENT),  LT(NUM, KC_DEL)
                                                         //`----------------------------------------------------'  `---------------------------------------------------------'
  ),
  ...
  [LOWER2] = LAYOUT_split_3x6_3( // same as LOWER2 + underscore, inaccessible from QWERTY: _?
  //,---------------------------------------------------------------------------------------.                                          ,------------------------------------------------------------------------------------------------------.
