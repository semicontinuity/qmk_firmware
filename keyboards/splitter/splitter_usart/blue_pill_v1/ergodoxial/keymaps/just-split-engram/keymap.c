...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //                                                                                  |-------------------------------------------------|   |---------------------------------------------|                                                                                      //
  ...
  [RPE] = LAYOUT_ergodox_pretty(
    _______,        _______,        _______,        _______,        _______,          _______,        _______,                                                _______,        _______,        _______,          _______,        _______,        _______,        _______,        //
    _______,        _______,        KC_S,           KC_J,           KC_E,             KC_X,           _______,                                                _______,        KC_Y,           KC_U,             KC_I,           KC_O,           _______,        _______,        //
    _______,        KC_COMMA,       LALT_T(KC_B),   LCTL_T(KC_T),   LSFT_T(KC_F),     KC_QUES,                                                                                KC_H,           LSFT_T(KC_J),     RCTL_T(KC_K),   LALT_T(KC_L),   KC_P,           _______,        //
    _______,        LGUI_T(KC_W),   RALT_T(KC_SCLN),KC_Q,           KC_R,             KC_UNDS,        _______,                                                _______,        KC_N,           KC_M,             KC_COMMA,       RALT_T(KC_DOT), RGUI_T(KC_SCLN),_______,        //
    _______,        KC_U,           _______,        KC_UNDS,        _______,                                                                                                                  _______,          KC_COMMA,       _______,        KC_SLASH,       _______,        //
 // ---------------------------------------------------------------|-----------------|-------------------------------------------------|   |-------------------------------------------------|-----------------|----------------------------------------------------------------//
                                                                                                      _______,        _______,              _______,          _______,                                                                                                          //
                                                                                                                      _______,              _______,                                                                                                                            //
                                                                                      _______,        _______,        _______,              _______,          _______,        _______                                                                                           //
 ...
 //                                                                                  |-------------------------------------------------|   |---------------------------------------------|                                                                                      //
  ...
  [R_LOWER] = LAYOUT_ergodox_pretty(
    _______,        _______,        _______,        _______,        _______,          _______,        _______,                                                _______,        _______,        _______,          _______,        _______,        _______,        _______,        //
    _______,        _______,        KC_QUOT, /*э*/  KC_GRV,/*ё*/    KC_AMPR,          KC_PERC,        _______,                                                _______,        KC_TILDE,       XXXXXXX,          KC_ASTERISK,    KC_PIPE, /*/*/  _______,        _______,        //
